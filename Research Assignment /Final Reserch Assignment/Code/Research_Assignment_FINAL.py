...
This python code use solution ideas form code HW 4 , 5 

G. Besla & R. Li & H. Foote + 2023 
"""
...
class TidalStreams:
    ...
    def calculate_mass_change(self):
        ...
        # Each snapshot represents a point in time during the simulation 
        snapshots = [1, 2, 3]
