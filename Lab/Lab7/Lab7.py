...
def density_contour(xdata, ydata, nbins_x, nbins_y, ax=None, **contour_kwargs):
    ...
    Add_sigma = so.brentq(find_confidence_interval, 0., 1., args=(pdf, .75))
    ...
    levels = [one_sigma, Add_sigma,two_sigma, three_sigma][::-1]
...
#camp Example : 'viridis', 'plasma', 'inferno', 'magma', 'cividis'
...
density_contour(xD, yD, 80, 80, ax=ax,colors=['cyan','pink','red','white'])
...
density_contour(rn[:,0],rn[:,1],80,80,ax=ax,colors=['cyan','pink','red','white'])
