...
class CosmologicalTools:
    ...
    def __init__(self, OmegaM0, OmegaR0, OmegaL0, h):
        ...
        self.OmegaK0 = 1 - (OmegaM0 + OmegaR0 +  OmegaL0 ) #### Curvature Density Parameter  #1-omegaM0 in lucture
...
if __name__ == '__main__':
    ...
    idx = np.where(BenchMark.OmegaR_Z(zrange) > BenchMark.OmegaM_Z(zrange))
    zRad = zrange [idx [0][0]]
    ...
    idx = np.where(BenchMark.OmegaM_Z(zrange) > BenchMark.OmegaL_Z(zrange))
