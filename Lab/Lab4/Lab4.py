...
plt.plot(data2['B']-data2['R'], data2['R'], color='gray', linewidth=5, label='2 Gyr')
...
#plt.plot(data4['B']-data4['R'], data4['R'], color='orange', linewidth=5, label='4 Gyr')
#plt.plot(data11['B']-data11['R'], data11['R'], color='pink, linewidth=5, label='11 Gyr')
plt.plot(data13['B']-data13['R'], data13['R'], color='green', linewidth=5, label='13 Gyr')
...
One of the factors that the tnteractions with other galaxies or gas clouds
    might cause the bursts of star formation
